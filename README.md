...
| [Принятие решений в бизнесе](decision_making_business) | Используя данные интернет-магазина приоритезировать гипотезы, произвести оценку результатов A/B-тестирования различными методами | *Pandas*, *SciPy*, *Matplotlib* |
...
| [Анализ сервиса для чтения книг](sql_service_reading_books) | Анализ данных на основании SQL-запросов | *Pandas*, *SQLAlchemy*, *SQL* |
| [Примеры презентаций](presentations) | Несколько презентаций из проектов | *MS PowerPoint* |
